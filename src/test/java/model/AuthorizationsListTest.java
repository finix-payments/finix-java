...
/**
 * Model tests for AuthorizationsList
 */
public class AuthorizationsListTest {
    private final AuthorizationsList model = new AuthorizationsList();
