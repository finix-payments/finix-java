...
import javax.ws.rs.core.GenericType;
    ...
    this.localCustomBaseUrl = customBaseUrl;
        ...
        * Build call for createWebhook
            * @param createWebhookRequest A form that needs to be implemented (optional)
        ...
        * Build call for getWebhook
            * @param webhookId ID of object (required)
        * @param _callback Callback for upload/download progress
        * @return Call to execute
        * @throws ApiException If fail to serialize the request body object
            * @http.response.details
        ...
        */
        ...
        /**
        * Build call for listApplicationWebhooks
        ...
        * @throws ApiException If fail to serialize the request body object
            * @http.response.details
            <table summary="Response Details" border="1">
                <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
                    <tr><td> 200 </td><td> List of webhooks </td><td>  * finix-apiuser-role -  <br>  * date -  <br>  * x-request-id -  <br>  </td></tr>
                    <tr><td> 401 </td><td> Authentication information is missing or invalid </td><td>  * finix-apiuser-role -  <br>  * date -  <br>  * x-request-id -  <br>  </td></tr>
                    <tr><td> 403 </td><td> Forbidden </td><td>  * finix-apiuser-role -  <br>  * date -  <br>  * x-request-id -  <br>  </td></tr>
                    <tr><td> 404 </td><td> Object does not exist </td><td>  * finix-apiuser-role -  <br>  * date -  <br>  * x-request-id -  <br>  </td></tr>
                    <tr><td> 406 </td><td> Not Acceptable </td><td>  * finix-apiuser-role -  <br>  * date -  <br>  * x-request-id -  <br>  </td></tr>
        ...
        */
        public okhttp3.Call listApplicationWebhooksCall(String applicationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
            String localVarPath = "/applications/{application_id}/webhooks"
        ...
        "application/hal+json"
            ...
            @SuppressWarnings("rawtypes")
            private okhttp3.Call listApplicationWebhooksValidateBeforeCall(String applicationId, final ApiCallback _callback) throws ApiException {
            
                    // verify the required parameter 'applicationId' is set
                    if (applicationId == null) {
                    throw new ApiException("Missing the required parameter 'applicationId' when calling listApplicationWebhooks(Async)");
                    }
            

                okhttp3.Call localVarCall = listApplicationWebhooksCall(applicationId, _callback);
                return localVarCall;
                ...
                */
                    public WebhooksList listByApplicationId(String applicationId) throws ApiException {
                ApiResponse<WebhooksList> localVarResp = listApplicationWebhooksWithHttpInfo(applicationId);
                        return localVarResp.getData();
                    }
        ...
        /**
            ...
            */
            public ApiResponse<WebhooksList> listApplicationWebhooksWithHttpInfo(String applicationId) throws ApiException {
            okhttp3.Call localVarCall = listApplicationWebhooksValidateBeforeCall(applicationId, null);
                    Type localVarReturnType = new TypeToken<WebhooksList>(){}.getType();
                    return localVarFinixClient.execute(localVarCall, localVarReturnType);
            }

        /**
            * List Application Webhooks (asynchronously)
            * Return a collection of webhooks, if there are no webhooks, an empty collection will be returned. 
                * @param applicationId ID of application to use (required)
            * @param _callback The callback to be executed when the API call finishes
            * @return The request call
            ...
            */
            public okhttp3.Call listApplicationWebhooksAsync(String applicationId, final ApiCallback<WebhooksList> _callback) throws ApiException {

            okhttp3.Call localVarCall = listApplicationWebhooksValidateBeforeCall(applicationId, _callback);
        Type localVarReturnType = new TypeToken<WebhooksList>(){}.getType();
            localVarFinixClient.executeAsync(localVarCall, localVarReturnType, _callback);
            return localVarCall;
            }
        ...
        */
        public okhttp3.Call listWebhooksCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        "application/hal+json"
            ...
            @SuppressWarnings("rawtypes")
            private okhttp3.Call listWebhooksValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
            

                okhttp3.Call localVarCall = listWebhooksCall(id, _callback);
                return localVarCall;
                ...
                */
                    public WebhooksList list(String id) throws ApiException {
                ApiResponse<WebhooksList> localVarResp = listWebhooksWithHttpInfo(id);
                        return localVarResp.getData();
                    }
        ...
        /**
            ...
            */
            public ApiResponse<WebhooksList> listWebhooksWithHttpInfo(String id) throws ApiException {
            okhttp3.Call localVarCall = listWebhooksValidateBeforeCall(id, null);
                    Type localVarReturnType = new TypeToken<WebhooksList>(){}.getType();
                    return localVarFinixClient.execute(localVarCall, localVarReturnType);
            }
        ...
        /**
            ...
            */
            public okhttp3.Call listWebhooksAsync(String id, final ApiCallback<WebhooksList> _callback) throws ApiException {

            okhttp3.Call localVarCall = listWebhooksValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<WebhooksList>(){}.getType();
            localVarFinixClient.executeAsync(localVarCall, localVarReturnType, _callback);
            return localVarCall;
            }
