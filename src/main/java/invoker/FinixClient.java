...
import invoker.auth.HttpBearerAuth;
...
public class FinixClient {
    ...
    private String basePath = "https://finix.sandbox-payments-api.com";
    ...
    */
     ...
     */
    public FinixClient(OkHttpClient client) {
        init();
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://finix.sandbox-payments-api.com
     * @return An instance of OkHttpClient
     */
    public FinixClient setBasePath(String basePath) {
     ...
     */
    public FinixClient setHttpClient(OkHttpClient newHttpClient) {
     ...
     * @return Api client
     */
    public FinixClient setJSON(JSON json) {
        this.json = json;
        return this;
    }
     ...
     * @return FinixClient
     */
    public FinixClient setVerifyingSsl(boolean verifyingSsl) {
     ...
     * @return FinixClient
     */
    public FinixClient setSslCaCert(InputStream sslCaCert) {
     ...
     * @return FinixClient
     */
    public FinixClient setKeyManagers(KeyManager[] managers) {
     ...
     * @return a {@link invoker.FinixClient} object
     */
    public FinixClient setDateFormat(DateFormat dateFormat) {
     ...
     * @return a {@link invoker.FinixClient} object
     */
    public FinixClient setSqlDateFormat(DateFormat dateFormat) {
     ...
     * @return a {@link invoker.FinixClient} object
     */
    public FinixClient setOffsetDateTimeFormat(DateTimeFormatter dateFormat) {
     ...
     * @return a {@link invoker.FinixClient} object
     */
    public FinixClient setLocalDateFormat(DateTimeFormatter dateFormat) {
     ...
     * @return a {@link invoker.FinixClient} object
     */
    public FinixClient setLenientOnJson(boolean lenientOnJson) {
     ...
     * @return FinixClient
     */
    public FinixClient setUserAgent(String userAgent) {
     ...
     * @return FinixClient
     */
    public FinixClient addDefaultHeader(String key, String value) {
     ...
     * @return FinixClient
     */
    public FinixClient addDefaultCookie(String key, String value) {
     ...
     * @return FinixClient
     */
    public FinixClient setDebugging(boolean debugging) {
     ...
     * @return FinixClient
     */
    public FinixClient setTempFolderPath(String tempFolderPath) {
     ...
     * @return Api client
     */
    public FinixClient setConnectTimeout(int connectionTimeout) {
     ...
     * @return Api client
     */
    public FinixClient setReadTimeout(int readTimeout) {
     ...
     * @return Api client
     */
    public FinixClient setWriteTimeout(int writeTimeout) {
     ...
     * @throws invoker.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws invoker.ApiException If fail to serialize the given object
     */
     ...
     * @throws invoker.ApiException If fail to read file content from response and write to disk
     ...
     * @throws invoker.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws invoker.ApiException If the response has an unsuccessful status code or
     ...
     * @throws invoker.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws invoker.ApiException If fails to update the parameters
     */
     ...
     * @throws invoker.ApiException If fail to serialize the request body object into a string
     */
