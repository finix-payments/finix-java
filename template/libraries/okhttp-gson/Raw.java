...
@lombok.Builder
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-06-14T17:40:40.747062-05:00[America/Chicago]")
public class Raw extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Raw.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Raw' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Raw>() {
                @Override
  ...
  * @throws IOException if the JSON Object is invalid with respect to Raw
*/
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for Raw with anyOf schemas: Object, String. JSON: %s", jsonObj.toString()));
    }
  }

 /**
  * Create an instance of Raw given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Raw
  * @throws IOException if the JSON string is invalid with respect to Raw
  */
  public static Raw fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Raw.class);
  }

 /**
  * Convert an instance of Raw to an JSON string
  *
  * @return JSON string
  */
